          ...
          <div className="row text-center">
            ...
            <div className="col-xl-6 col-sm-6 mb-3">
              <div className="bg-white rounded shadow-lg py-3 px-4">
                ...
                >
                  Adebayo is a Software Developer in Maitama Abuja. Adebayo has
                  a Bachelor's Degree in Electrical/Electronic. He spends most
                  of his time working with Javascript, CSS3, HTML5, React and he
                  is passionate about everything related to software development
                  and a great teacher. He will be introducing the the student to
                  computer science and further-more, He will be taking the
